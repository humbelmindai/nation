          ...
          <Card variant="elevated">
            <CardHeader className="text-center">
              <div className="w-16 h-16 bg-primary-600 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-white font-bold text-2xl">420</span>
              </div>
              <CardTitle className="text-2xl">Join 420 Nation</CardTitle>
              <p className="text-gray-600 mt-2">
                Create your cannabis wellness account
              </p>
            </CardHeader>
                ...
                <div className="space-y-3">
                  <label className="flex items-start">
                    ...
                    <span className="ml-2 text-sm text-gray-600">
                      I certify that I am 21 years of age or older and agree to the{' '}
